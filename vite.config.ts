...
// media-src https: allows the Deezer track previews (cdnt-preview.dzcdn.net).
    ...
    return [
      {
        ...
        attrs: {
          ...
          content:
            "default-src 'self'; script-src 'self'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:; media-src 'self' https:; connect-src 'self' https:; font-src 'self' data:; object-src 'none'; base-uri 'none'",
        },
